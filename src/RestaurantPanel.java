...
public class RestaurantPanel extends JPanel {
    ...
    public RestaurantPanel(String modeName) {
        ...
        side.setMinimumSize(new Dimension(460, 400));
    ...
    private void configureClientTableColumns() {
        int[] widths = new int[]{44, 58, 56, 74, 92, 180, 96};
        for (int i = 0; i < widths.length && i < clientsTable.getColumnModel().getColumnCount(); i++) {
            clientsTable.getColumnModel().getColumn(i).setPreferredWidth(widths[i]);
        }
    }
